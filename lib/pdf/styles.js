...
export const styles = StyleSheet.create({
  ...
  notice: {
    ...
    textTransform: "uppercase",
    // textAlign was "justify" — caused soft-hyphen / odd-spacing artifacts on
    // long all-caps words like "IGNORE" and "AUTHORITY" because the renderer
    // attempts to hyphenate or space-stretch. Sprint 4b.1 R3 fix: use "left"
    // alignment. Statutory all-caps text remains visually impactful without
  ...
  body: {
    marginBottom: SIZES.PARA_SPACING,
    // textAlign was "justify" — same hyphenation-artifact issue. Body text
    // reads cleanly with default "left" alignment and is more accessible
    // for screen readers and OCR processing.
    textAlign: "left",
  },
