...
export function createInitialState() {
  return {
    ...
    // Sprint 4b.3: successor address now captured as structured fields,
    // matching the primary agent layout. The legacy combined field
    // `successorAgentAddress` is retained for the street portion only —
    // city/state/zip are now separate fields.
    ...
    powersScope: null, // Sprint 4b.1 R3: "broad" | "limited" | "custom" | null
    agentCompensation: null, // Sprint 4b.1 R3: "reasonable" | "no_compensation" | null
    specialInstructions: "", // Sprint 4b.1 R3: free-text limiting or extending powers
